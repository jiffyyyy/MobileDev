            ...
            return (
              <div className="card" style={{width: "18rem"}}key={restaurants.id}>
                ...
                <div className="card-body">
                  ...
                  <Link to={""} className="btn btn-danger px-2" onClick={() =>handleDelete(restaurants.id)}>Delete</Link>
                   <Link to={"/update/" + restaurants.id} className="btn btn-warning px-2">Edit</Link>
                </div>
              </div>
            );
          })}
