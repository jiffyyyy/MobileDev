...
import { faBed, faCalendarDays,faCar,faPerson,faPlane,faTaxi,faEarthAmericas } from '@fortawesome/free-solid-svg-icons'
...
const Header = () => {
    ...
    const [date, setDate] = useState([ //เลือกวันที่ สิ่งที่เก็บอยู่ใน state
        {
            startDate: new Date(),
            endDate:new Date(),
            key:"selection"
    ...
    const [options, setOptions] = useState({  //สิ่งที่เก็บใน state
        adult:2,
        children:0,
        room:1
    });
    ...
    <div className='header'> 
        <div className='headerContainer'>
            ...
            <p className='headerDescription'>
                Get rewarded for your travel - unlick instant savings of 10% or more with a free SE Booking account.
            </p>
